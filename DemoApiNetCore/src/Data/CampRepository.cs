...
namespace CoreCodeCamp.Data
{
    public class CampRepository : ICampRepository
    {
        ...
        public async Task<Camp> GetCampById(int id, bool includeTalks = false)
        {
            ...
            // Query It
            query = query.Where(c => c.CampId == id);
        ...
        public async Task<Talk> GetTalkByIdAsync(int Id, bool includeSpeakers = false)
        {
            _logger.LogInformation($"Getting all Talks for a Camp");
        ...
        //      .OrderBy(t => t.VenueName);          
        //    return await query.ToListAsync();
        //}

        //public async Task<Location> GetLocationsByIdAsync(int Id)
        //{
        //    _logger.LogInformation($"Getting Location for by {Id}");
